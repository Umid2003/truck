    ...
    return (
        <nav className='bg-[#011631] h-[10vh] sticky top-0 w-[100vw] items-center text-white flex justify-between px-10 z-10 max-md:px-8'>
            ...
            <ul className={!showNavbar ? 'gap-16 flex max-md:hidden' : 'gap-20 flex max-md:absolute max-md:right-0 max-md:top-[10vh] max-md:bg-[#011631c8] max-md:w-[40vw] max-md:text-center max-md:pt-4 max-md:h-[40vh] max-md:flex-col max-md:shadow-md max-md:shadow-slate-400'}>
                <li onClick={() => setShowNavbar(false)} className='hover:opacity-100 border-dashed border-white border-2 border-y-transparent duration-300 opacity-60 px-2 hover:border-y-white hover:border-x-transparent max-md:border-none'><Link to="/">Bosh sahifa</Link></li>
                <li onClick={() => setShowNavbar(false)} className='hover:opacity-100 border-dashed border-white border-2 border-y-transparent duration-300 opacity-60 px-2 hover:border-y-white hover:border-x-transparent max-md:border-none'><Link to="/about">Biz haqimizda</Link></li>
                <li onClick={() => setShowNavbar(false)} className='hover:opacity-100 border-dashed border-white border-2 border-y-transparent duration-300 opacity-60 px-2 hover:border-y-white hover:border-x-transparent max-md:border-none'><Link to="/contact">Aloqa</Link></li>
            </ul>
